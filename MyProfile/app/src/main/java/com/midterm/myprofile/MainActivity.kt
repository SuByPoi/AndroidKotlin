...
import com.midterm.myprofile.ui.theme.MyProfileTheme
                    ...
                    color = MaterialTheme.colors.background
                        ...
                        Card(
                            ...
                            Column(
                                ...
                                Divider()
                                if(status.value) Portfolio(data = listOf("Project 1","Project 2","Project 3"))
                            }
                        }
                }
            }
...
fun CreateInfo(){
    Column(modifier = Modifier.padding(3.dp)) {
        Text(text = "Nguyen Thai Loc",
        style = MaterialTheme.typography.h4,
        color = MaterialTheme.colors.primaryVariant)
        Text(text = "Android progammer",
